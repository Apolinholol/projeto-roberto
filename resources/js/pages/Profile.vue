        ...
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <div class="d-flex justify-content-center mb-5">
                    <div class="user-info p-3 d-flex align-items-center" style="max-width: 1200px; min-width: 300px; width: 100%;">
                        <div class="text-center me-4" style="flex-shrink: 0;">
                            <img :src="state.usuario?.image_path" alt="Foto do usuário" class="profile-picture">
                        </div>

                        <div class="user-details flex-grow-1" style="border: 1px solid #022413;">
                            ...
                            <div class="d-flex ml-4 mt-2">
                                ...
                                <p class="user-username d-flex mb-0 ml-2 align-items-center">
                                    {{ state.usuario?.nomeUsuario || 'Nome de usuário não informado' }}
                                </p>
                            </div>

                            <!-- Email - Mostrar apenas se for o próprio perfil -->
                            <div v-if="isOwnProfile" class="d-flex ml-4 mt-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
                            ...
                            <div v-if="isOwnProfile" class="d-flex ml-4 mt-2">
                                ...
                                <p class="user-cpf d-flex mb-0 ml-2 align-items-center">
                            ...
                            <div v-if="!isOwnProfile" class="d-flex ml-4 mt-2">
                                ...
                                <p class="d-flex mb-0 ml-2 align-items-center text-muted">
                                    <small>Membro desde {{ formatarDataEntrada(state.usuario?.created_at) }}</small>
                                </p>
                            </div>

                            <!-- Botão de editar - apenas se for próprio perfil -->
                            <div v-if="isOwnProfile" class="d-flex justify-content-end mt-2">
                                <button class="btn btn-primary mb-2 mx-2 d-flex align-items-center"
                                    style="border-radius: 30px; background-color: #0b492a; font-size: 12px; font-weight: 700;"
                            ...
                            <div v-if="!isOwnProfile" class="d-flex justify-content-around mt-3 p-2" style="background-color: #f8f9fa; border-radius: 8px;">
                                <div class="text-center">
                                    <h6 class="mb-1 text-success">{{ anunciosAtivos }}</h6>
                                    <small class="text-muted">Anúncios Ativos</small>
                                </div>
                                <div class="text-center">
                                    <h6 class="mb-1 text-primary">{{ totalAnuncios }}</h6>
                                    <small class="text-muted">Total de Anúncios</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="user-info p-3 mb-3 mt-10 d-flex flex-column align-items-center justify-content-center"
                    ...
                    <h3 class="d-flex align-items-center justify-content-center" style="padding-top: 13px;">
                        {{ isOwnProfile ? 'HISTÓRICO DE ANÚNCIOS' : 'ANÚNCIOS DO VENDEDOR' }}
                    </h3>

                    <div class="w-100">
                        <p class="justify-content-center mt-1 mb-3 text-center">
                            {{ isOwnProfile 
                        ...
                        <div v-if="!anuncios || anuncios.length === 0" class="text-center"
                            ...
                            <p class="text-muted mb-0">
                                ...
                                <a v-if="isOwnProfile" href="/AdsManager" style="color: #0b492a; font-weight: 700;">
    ...
    <div class="modal fade" :class="{ 'show d-block': state.modalEdicao }" tabindex="-1" 
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" style="max-width: 90%; width: 600px;">
            <div class="modal-content">
                <div class="modal-header" style="background: linear-gradient(to bottom, #00ac59, #0b492a); color: white;">
                    ...
                    <form @submit.prevent="salvarPerfil">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select" id="uf" v-model="state.formEdicao.uf" required>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <div class="mb-3" v-if="state.usuario?.image_path">
                                    ...
                                    <img :src="state.usuario.image_path" 
                                         alt="Foto atual" 
                                         style="width: 100px; height: 100px; border-radius: 50%; object-fit: cover; border: 2px solid #049f55;">
                                </div>
                                
                                <!-- Preview da nova foto -->
                                <div class="mb-3" v-if="state.previewNovaFoto">
                                    <p class="small text-muted mb-2">Nova foto:</p>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" @click="fecharModalEdicao">
                        <i class="bi bi-x-lg me-1"></i>
                        Cancelar
                    </button>
                    <button type="button" class="btn btn-success" @click="salvarPerfil" :disabled="state.salvandoPerfil">
