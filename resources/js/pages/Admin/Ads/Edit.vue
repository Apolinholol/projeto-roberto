...
const form = useForm({
    name: props.ads.name,
    description: props.ads.description,
    price: props.ads.price,
    stock: props.ads.stock,
    is_active: props.ads.is_active,
    category_id: props.ads.category_id,
})

function submit() {
    form.put(route('admin.ads.update', props.ads.id))
}
</script>

<template>
    <AppLayout title="Editar Anúncio">
